...
const ContactUsPage = () => {
  ...
  const quickLinks = [
    ...
    },
    {
      ...
      path: '/consult-a-vet?action=chat',
    },
  ];
  ...
  const browseTopics = [
    ...
    {
    icon: <FaCommentDots className="text-orange-600 text-2xl" />, // New General Query icon
    title: 'General Query',
    path: '/help/general', // Update this to match your route
  },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-100 font-inter">
      ...
      <main className="container mx-auto px-4 py-6 md:py-10">
        {/* Sign In Section - Enhanced for Mobile & Desktop */}
  ...
  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
    ...
    <div className="w-full md:w-auto">
      <button
        ...
        className="w-full md:w-auto flex items-center justify-center gap-2 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white px-6 py-3 text-sm md:text-base font-semibold rounded-full shadow-md transition-all duration-200"
      >
...
<section className="mt-8">
  ...
  <p className="text-sm text-gray-600 mb-4">If you have any inquiries, feel free to</p>
...
>
  <div className="flex items-center gap-4">
    ...
    <div>
      <span className="text-md font-medium text-gray-800 block">
        Email us at
      </span>
