    ...
    fullContent: (
      <>
        ...
        <ul className="list-disc list-inside text-gray-700 mb-4 ml-4">
          ...
          <li><strong>Vomiting and Weakness:</strong> As toxins accumulate in the bloodstream.</li>
  ...
  },
  {
    ...
    fullContent: (
      <>
        ...
        <ul className="list-disc list-inside text-gray-700 mb-4 ml-4">
          <li><strong>Frequent or Projectile Vomiting:</strong> Vomiting multiple times a day or or with great force.</li>
    ...
    fullContent: (
      <>
        ...
        <ul className="list-disc list-inside text-gray-700 mb-4 ml-4">
          ...
          <li><strong>Isolation:</strong> Infected dogs must be isolated to prevent spread to other animals.</li>
        </ul>
          ...
          {blogPosts.map((post) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                {/* Changed the Link path to use the post.id */}
                <Link
                  to={`/blog/${post.id}`}
